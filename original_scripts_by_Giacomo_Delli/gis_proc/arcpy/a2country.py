...
log = open("Z:/globes/USERS/GIACOMO/protconn/logs/a2_country.log", "a")
sys.stdout = log
...
arcpy.env.workspace = "Z:/globes/USERS/GIACOMO/protconn/data/ProtConn_Jun2020.gdb"
...
# input shp
input_shp = outpath+"/wdpa_all_relevant_simpl.shp"
...
arcpy.CopyFeatures_management(wdpa_multi_iso3_together_dissolved_ISO3final_1km2_singleparted, wdpa_flat_1km_final, "", "0", "0", "0")
print("Final layer copied to wdpa_flat_1km_final")
...
arcpy.TableToTable_conversion(in_rows=wdpa_flat_1km_final, out_path=outpath, out_name=outfile_attr)
...
# arcpy.FeatureClassToFeatureClass_conversion(in_features=wdpa_flat_1km_final, out_path=outpath, out_name=wdpa_flat_1km_final, where_clause="", field_mapping='ISO3final "ISO3final" true true false 50 Text 0 0 ,First,#,wdpa_flat_1km_final,ISO3final,-1,-1;AREA_GEO "AREA_GEO" true true false 8 Double 0 0 ,First,#,wdpa_flat_1km_final,AREA_GEO,-1,-1;ORIG_FID "ORIG_FID" true true false 4 Long 0 0 ,First,#,wdpa_flat_1km_final,ORIG_FID,-1,-1;nodeID "nodeID" true true false 4 Long 0 0 ,First,#,wdpa_flat_1km_final,nodeID,-1,-1;Shape_Leng "Shape_Leng" false true true 8 Double 0 0 ,First,#,wdpa_flat_1km_final,Shape_Length,-1,-1;Shape_Area "Shape_Area" false true true 8 Double 0 0 ,First,#,wdpa_flat_1km_final,Shape_Area,-1,-1', config_keyword="")
# print("wdpa_flat_1km_final exported to Shapefile")

# # Process: Generate Near Table(MUCH BETTER/FASTER IN POSTGIS)
...
# arcpy.GenerateNearTable_analysis(wdpa_flat_1km_final, wdpa_flat_1km_final, all_distances, "300 Kilometers", "NO_LOCATION", "NO_ANGLE", "ALL", "0", "GEODESIC")
# print("Near Table generated")

# # Process: Copy Rows
# arcpy.CopyRows_management(all_distances, outfile_dist)
...
print('Now execute in docker the script "/globes/USERS/GIACOMO/protconn/scripts/gis_proc/exec_generate_near_table_country.sh" ')
print(' ')
