...
# the following two folders are to be created
node_dist_files_230_km_folder <- 'C:/Users/wyang80/Desktop/ProtConn/STATES/state_files_with_trans_test4'
node_dist_files_without_trans_230_km_folder <- 'C:/Users/wyang80/Desktop/ProtConn/STATES/state_files_without_trans_test4'
...
Raw_Nodes <- Raw_Nodes[Raw_Nodes$ifPA == 1, ]
...
for (i in list_id)
{
  ...
  # temp_Distances_current_country <- Distances[Distances$IN_ORIG_FID %in% Nodes_current_country$ORIG_FID | Distances$NEAR_ORIG_FID %in% Nodes_current_country$ORIG_FID,]
  ...
  # temp_Distances_current_county <- temp_Distances_current_county[! (! temp_Distances_current_county$IN_ORIG_FID %in% Nodes_current_county$ORIG_FID & ! temp_Distances_current_county$NEAR_ORIG_FID %in% Nodes_current_county$ORIG_FID),]
  # temp_Nodes_FINAL_current_country <- Nodes[Nodes$ORIG_FID %in% temp_Distances_current_country$IN_ORIG_FID  | Nodes$ORIG_FID %in% temp_Distances_current_country$NEAR_ORIG_FID | Nodes$ORIG_FID %in% Nodes_current_country$ORIG_FID,]
  ...
  # Distances_current_county <- Distances[Distances$IN_ORIG_FID %in% temp_Nodes_FINAL_current_county$ORIG_FID | Distances$NEAR_ORIG_FID %in% temp_Nodes_FINAL_current_county$ORIG_FID,]
  Distances_current_county <- Distances[Distances$IN_ORIG_FID %in% temp_Nodes_FINAL_current_county$ORIG_FID & Distances$NEAR_ORIG_FID %in% temp_Nodes_FINAL_current_county$ORIG_FID,]
  # Distances_current_county <- Distances[Distances$IN_ORIG_FID %in% Nodes_current_county$ORIG_FID & Distances$NEAR_ORIG_FID %in% temp_Nodes_FINAL_current_county$ORIG_FID,]
  # Distances_current_county <- Distances[Distances$IN_ORIG_FID %in% temp_Nodes_FINAL_current_county$ORIG_FID & Distances$NEAR_ORIG_FID %in% temp_Nodes_FINAL_current_county$ORIG_FID,]
  ...
  # Distances_current_country_WITHOUT_TRANS <- Distances[Distances$IN_ORIG_FID %in% Nodes_current_country$ORIG_FID & Distances$NEAR_ORIG_FID %in% Nodes_current_country$ORIG_FID,]
  Distances_current_county_WITHOUT_TRANS <- Distances[Distances$IN_ORIG_FID %in% Nodes_current_county$ORIG_FID & Distances$NEAR_ORIG_FID %in% Nodes_current_county$ORIG_FID,]
  ...
  # Nodes_FINAL_current_country <- Nodes[Nodes$ORIG_FID %in% Distances_current_country$IN_ORIG_FID  | Nodes$ORIG_FID %in% Distances_current_country$NEAR_ORIG_FID | Nodes$ORIG_FID %in% Nodes_current_country$ORIG_FID,]
  Nodes_FINAL_current_county <- Nodes[Nodes$ORIG_FID %in% Distances_current_county$IN_ORIG_FID  | Nodes$ORIG_FID %in% Distances_current_county$NEAR_ORIG_FID | Nodes$ORIG_FID %in% Nodes_current_county$ORIG_FID,]
  ...
  Nodes_FINAL_current_county_WITHOUT_TRANS <-Nodes_current_county
  ...
  Nodes_FINAL_current_county$AREA_GEO[is.na(Nodes_FINAL_current_county$GEOID)] <- 0
  ...
  Nodes_FINAL_current_county_WITHOUT_TRANS$GEOID <- NULL
  ...
  write.table(Nodes_FINAL_current_county_WITHOUT_TRANS, file=node_file_name_WITHOUT_TRANS, row.names = FALSE, col.names = FALSE,  sep="\t")
  ...
  write.table(Distances_current_county, file=distance_file_name, row.names = FALSE, col.names = FALSE,  sep="\t")
  ...
  write.table(Distances_current_county_WITHOUT_TRANS, file=distance_file_name_WITHOUT_TRANS, row.names = FALSE, col.names = FALSE,  sep="\t")
